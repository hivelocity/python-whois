...
class WhoisEntry(dict):
    ...
    _regex = {
        'admin_email':              'Admin\sEmail: *(.+)',
        'admin_first':              'Admin\sName: *(.+)',
        'admin_last':               'Admin\sName: *(.+)',
        'admin_email':              'Admin\sEmail: *(.+)',
        'admin_phone':              'Admin\sPhone: *(.+)',
        'admin_country':            'Admin\sCountry: *(.+)',
        #
        'org_address':              'Registrant\sOrganization: *(.+)',
        'org_city':                 'Registrant\sCity: *(.+)',
        'org_country':              'Registrant\sCountry: *(.+)',
        'org_locality':             'Registrant\sCity: *(.+)',
        'org_phone':                'Registrant\sPhone: *(.+)',
        'org_postalcode':           'Registrant\sPostal Code: *(.+)',
        'org_region':               'Registrant\sCity: *(.+)',
        'org_state':                'Registrant\sState\/Province: *(.+)',
        'org_name':                 'Registrant\sName: *(.+)',
        'org_address':              'Registrant\sStreet: *(.+)',
        #
        'tech_email':               'Tech\sEmail: *(.+)',
        'tech_first':               'Tech\sName: *(.+)',
        'tech_last':                'Tech\sName: *(.+)',
        'tech_phone':               'Tech\sPhone: *(.+)',
        'tech_country':             'Tech\sCountry: *(.+)',
